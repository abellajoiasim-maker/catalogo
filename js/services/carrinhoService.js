// ==========================================================================
// ARQUIVO: js/services/carrinhoService.js
// CORRIGIDO: O import do 'storage' apontava para '../utils/storage.js'
// que estava ausente. O arquivo foi criado e o caminho está correto agora.
// A chave STORAGE_KEY também foi alinhada com a chave usada nos HTMLs
// do projeto ('carrinho' em vez de 'abella_joias_carrinho') para garantir
// compatibilidade com o carrinho.html e produtos.html existentes.
// ==========================================================================
...
class CarrinhoService {
    constructor() {
        // CORRIGIDO: Alinhado com a chave usada diretamente nos HTMLs do projeto
        this.STORAGE_KEY = 'carrinho';
    ...
    adicionarItem(produto, quantidade = 1) {
        ...
        if (itemExistente) {
            ...
            this.itens.push({
                ...
                // CORRIGIDO: Compatibilidade com ambos os campos de preço do Firebase
                precoFinal: Number(produto.precoFinal || produto.price || produto.preco) || 0,
                preco: Number(produto.precoFinal || produto.price || produto.preco) || 0,
                imagem: produto.imagem || produto.image || '',
                image: produto.imagem || produto.image || '',
                sku: produto.sku || produto.codigo || '',
                peso: Number(produto.peso || produto.weight) || 0,
                weight: Number(produto.peso || produto.weight) || 0,
